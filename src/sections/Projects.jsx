    ...
    <section id='projects' className="c-space section-spacing">
      ...
      <div className="gap-4 mt-12 flex flex-col space-y-4">
        {projects.map((project) => (
          <div
            key={project.id}
            className="flex flex-col md:flex-row md:items-center gap-4 rounded-2xl bg-gradient-to-t from-[#0B0B0D] to-[#1E1F22] hover:scale-105 transition-transform duration-300"
          >
            <img
              src={project.image}
              alt={project.title}
